...
function MosqueSilhouette() {
  return (
    <svg viewBox="0 0 800 200" fill="white" xmlns="http://www.w3.org/2000/svg" className="w-full">
      ...
      {/* Gate arch cutout hint */}
      <path
        d="M365 188 L365 158 Q400 133 435 158 L435 188"
        fill="rgba(15,61,38,0.6)"
      />
    </svg>
  )
}
...
export function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (authError) {
      setError('Emel atau kata laluan tidak sah. Cuba semula.')
      setLoading(false)
      return
    }
